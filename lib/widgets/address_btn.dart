...
import '../services/address_storage.dart';
...
class _HomeMyAddressState extends State<HomeMyAddress> {
  ...
  Future<void> _loadAddresses() async {
    List<String> addresses = await AddressStorage.getAddresses();
    setState(() {
  ...
  Future<void> _deleteAddress(int index) async {
    ...
    setState(() {
      ...
      prefs.setStringList('addresses', addressList);
    });
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<String>>(
      future: AddressStorage.getAddresses(),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: Card(
                        color:
                            Colors.white, // 🏷️ Each tile inside a white card
                        elevation: 3,
